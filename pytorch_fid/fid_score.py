...
parser.add_argument('--path', type=str, nargs=2, default=["pytorch_fid/fid_stats_celeba.npz", "images/eval/celeba_v_diffusion_enc_120hhh"])
#   pytorch_fid/cifar10_train_stat.npy   
IMAGE_EXTENSIONS = {'bmp', 'jpg', 'jpeg', 'pgm', 'png', 'ppm',
                    'tif', 'tiff', 'webp'}

# python -m pytorch_fid images/cifar10/samples x --device cuda:0
