...
if __name__ == "__main__":
    ...
    parser.add_argument("--epochs", default=1200, type=int, help="total number of training epochs")
    ...
    parser.add_argument("--model-out-type", choices=["x0", "eps", "both", "v"], default="v", type=str)
    ...
    parser.add_argument("--use-cfg", default=False, help="whether to use classifier-free guidance")
    parser.add_argument("--w-guide", default=4, type=float, help="classifier-free guidance strength")
    ...
    parser.add_argument("--image-intv", default=5, type=int)
    ...
    parser.add_argument("--chkpt-dir", default="./checkpoints/teacher", type=str)
    parser.add_argument("--chkpt-name", default="celeba_v_diffusion_enc_240.pt", type=str)
    ...
    # parser.add_argument("--rdzv_backend", default="c10d", type=str)
    # parser.add_argument("--standalone", action="store_true")
    # 
    main(parser.parse_args())

    # python train_cond.py --use-ema --use-ddim --use-cfg --eval --resume
    # python -m torch.distributed.run --standalone --nproc_per_node 2 --rdzv_backend c10d train_cond.py --distributed
    # python -m torch.distributed.run train_cond.py